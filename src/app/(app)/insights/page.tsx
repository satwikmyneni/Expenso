...
function InsightsContent() {
  ...
  return <>
    ...
    <div className="mb-5 flex min-w-0 flex-wrap items-center gap-2">
      ...
      <div className="flex min-w-0 max-w-full flex-1 items-center gap-2 sm:flex-none"><Button variant="secondary" size="icon" aria-label="Previous period" onClick={()=>navigate(view==="yearly"?addYears(periods.reference,-1):addMonths(periods.reference,-1))}><ChevronLeft className="size-4"/></Button>
